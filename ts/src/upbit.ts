            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'market/all': 3,
                        'candles/{timeframe}': 3,
                        'candles/{timeframe}/{unit}': 3,
                        'candles/minutes/{unit}': 3,
                        'candles/minutes/1': 3,
                        'candles/minutes/3': 3,
                        'candles/minutes/5': 3,
                        'candles/minutes/10': 3,
                        'candles/minutes/15': 3,
                        'candles/minutes/30': 3,
                        'candles/minutes/60': 3,
                        'candles/minutes/240': 3,
                        'candles/days': 3,
                        'candles/weeks': 3,
                        'candles/months': 3,
                        'trades/ticks': 3,
                ...
                'private': {
                    'get': {
                        ...
                        'withdraw': 1,
                        'withdraws/chance': 1,
                        'withdraws/coin_addresses': 1,
                        'deposits': 1,
                        'deposit': 1,
                        'deposits/chance/coin': 1,
                        'deposits/coin_addresses': 1,
                        'deposits/coin_address': 1,
                        'travel_rule/vasps': 1,
                        'api_keys': 1, // Upbit KR only
                        'status/wallet': 1, // Upbit KR only
                    },
                    'post': {
                        'orders': 4,
                        'withdraws/coin': 1,
