            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'market/all': 3.375,
                        'candles/{timeframe}': 3.375,
                        'candles/{timeframe}/{unit}': 3.375,
                        'candles/seconds': 3.375,
                        'candles/minutes/{unit}': 3.375,
                        'candles/minutes/1': 3.375,
                        'candles/minutes/3': 3.375,
                        'candles/minutes/5': 3.375,
                        'candles/minutes/10': 3.375,
                        'candles/minutes/15': 3.375,
                        'candles/minutes/30': 3.375,
                        'candles/minutes/60': 3.375,
                        'candles/minutes/240': 3.375,
                        'candles/days': 3.375,
                        'candles/weeks': 3.375,
                        'candles/months': 3.375,
                        'candles/years': 3.375,
                        'trades/ticks': 3.375,
                        'ticker': 3.375,
                        'ticker/all': 3.375,
                        'orderbook': 3.375,
                        'orderbook/supported_levels': 3.375, // Upbit KR only
                    },
                },
                'private': {
                    'get': {
                        ...
                        'deposits': 1,
                        'deposit': 1,
                        'deposits/coin_addresses': 1,
                        'deposits/coin_address': 1,
                    },
                    'post': {
                        'orders': 4,
                        'withdraws/coin': 1,
                        'withdraws/krw': 1,
                        'deposits/generate_coin_address': 1,
                    },
                    'delete': {
                        'order': 1,
                    },
